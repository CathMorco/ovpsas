...
<head>
    ...
    <title>@yield('title', 'OVPSAS Portal')</title>
...
<body class="bg-gray-100 font-sans antialiased flex flex-col min-h-screen" 
    ...
    <footer class="bg-gray-800 text-white py-4 text-center text-xs">&copy; {{ date('Y') }} OVPSAS Portal. Polytechnic University of the Philippines.</footer>
