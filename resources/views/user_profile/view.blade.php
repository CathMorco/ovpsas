    ...
    <div class="min-h-screen flex flex-col bg-gray-100">
        ...
        <div class="flex-1 w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 px-4 sm:px-6 lg:px-8 py-10">
            ...
            <div class="md:col-span-4 flex flex-col items-center flex-shrink-0">
                ...
                {{-- Avatar Circle (Merged Logic: Checks for Uploaded Image first) --}}
                ...
                <div class="text-center mb-6">
                    ...
                    <p class="text-sm font-bold text-gray-400 tracking-wide">
                        {{ $user->suffix ?? '' }}
                    </p>
                </div>
                        ...
                        <div class="bg-gray-50 p-4 border-b border-gray-200 grid grid-cols-1 md:grid-cols-12 gap-x-4 gap-y-3">
                            ...
                            <div class="md:col-span-4">
                                ...
                                <input type="text" name="search" value="{{ request('search') }}" placeholder="Keyword..." 
                                    class="w-full border border-gray-300 rounded px-3 py-2 text-xs text-gray-800 focus:ring-1 focus:ring-[#800000] focus:border-[#800000]">
                            </div>
                            ...
                            <div class="bg-white border-l-4 border-[#800000] rounded shadow-sm p-4 hover:shadow-md transition group border border-gray-100">
                                <div class="flex justify-between items-start">
                                    <div>
                                        ...
                                        <h4 class="text-sm font-bold text-gray-800 uppercase leading-tight">
                                            {{ $announcement->title }}
                                        </h4>
                                    </div>
